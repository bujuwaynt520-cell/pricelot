    ...
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-zinc-200/80 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        >
          <div className="flex items-baseline">
            ...
            <span className="hidden sm:inline-block text-[9px] font-mono tracking-wider uppercase text-zinc-400 ml-2.5 bg-zinc-100 px-1.5 py-0.5 rounded border border-zinc-200/60 leading-none">
              Trading Hub V1
            </span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="hidden sm:inline font-bold text-[9px] font-mono bg-zinc-200 px-1.5 py-0.5 rounded text-zinc-500">
              Ctrl+K
            </span>
          </button>
      ...
      {isOpen && (
        <div className="md:hidden border-b border-zinc-200 bg-white p-4 space-y-2 animate-fade-in shadow-inner">
          <div className="text-zinc-400 text-[10px] font-mono tracking-wider uppercase px-3 pb-1">
            Navigation Menu
          </div>
